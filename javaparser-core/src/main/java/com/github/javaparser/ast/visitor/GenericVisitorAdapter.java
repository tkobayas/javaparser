...
public abstract class GenericVisitorAdapter<R, A> implements GenericVisitor<R, A> {
    ...
    @Override
    public R visit(final BigDecimalLiteralExpr n, final A arg) {
        R result;
        if (n.getComment().isPresent()) {
            result = n.getComment().get().accept(this, arg);
            if (result != null)
    ...
    @Override
    public R visit(final BigIntegerLiteralExpr n, final A arg) {
        R result;
        if (n.getComment().isPresent()) {
            result = n.getComment().get().accept(this, arg);
            if (result != null)
    ...
    @Override
    public R visit(final DrlNameExpr n, final A arg) {
        R result;
        {
            result = n.getName().accept(this, arg);
            if (result != null)
    ...
    @Override
    public R visit(final DrlxExpression n, final A arg) {
        R result;
        {
    ...
    @Override
    public R visit(final ListCreationLiteralExpression n, final A arg) {
        R result;
        {
    ...
    @Override
    public R visit(final MapCreationLiteralExpressionKeyValuePair n, final A arg) {
        R result;
        {
            result = n.getKey().accept(this, arg);
            if (result != null)
                return result;
        }
        {
    ...
    @Override
    public R visit(final MapCreationLiteralExpression n, final A arg) {
        R result;
        {
            result = n.getExpressions().accept(this, arg);
            if (result != null)
