...
public class EqualsVisitor implements GenericVisitor<Boolean, Visitable> {
    ...
    public Boolean visit(final InlineCastExpr n, final Visitable arg) {
        final InlineCastExpr n2 = (InlineCastExpr) arg;
        if (!nodeEquals(n.getExpression(), n2.getExpression()))
            return false;
        if (!nodeEquals(n.getType(), n2.getType()))
            return false;
    ...
    @Override
    public Boolean visit(final FullyQualifiedInlineCastExpr n, final Visitable arg) {
        final FullyQualifiedInlineCastExpr n2 = (FullyQualifiedInlineCastExpr) arg;
        if (!nodeEquals(n.getExpression(), n2.getExpression()))
            return false;
        if (!nodeEquals(n.getType(), n2.getType()))
            return false;
