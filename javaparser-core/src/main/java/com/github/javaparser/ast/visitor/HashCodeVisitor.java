...
public class HashCodeVisitor implements GenericVisitor<Integer, Void> {
    ...
    @Override
    public Integer visit(final BigIntegerLiteralExpr n, final Void arg) {
        return (n.getValue().hashCode()) * 31 + (n.getComment().isPresent() ? n.getComment().get().accept(this, arg) : 0);
    }

    @Override
    public Integer visit(final DrlNameExpr n, final Void arg) {
    ...
    public Integer visit(final DrlxExpression n, final Void arg) {
        return (n.getBind().accept(this, arg)) * 31 + (n.getExpr().accept(this, arg)) * 31 + (n.getComment().isPresent() ? n.getComment().get().accept(this, arg) : 0);
    }
    ...
    public Integer visit(final HalfBinaryExpr n, final Void arg) {
        return (n.getOperator().hashCode()) * 31 + (n.getRight().accept(this, arg)) * 31 + (n.getComment().isPresent() ? n.getComment().get().accept(this, arg) : 0);
    }

    @Override
    public Integer visit(final HalfPointFreeExpr n, final Void arg) {
        return (n.getArg1().accept(this, arg)) * 31 + (n.getArg2().accept(this, arg)) * 31 + (n.getArg3().accept(this, arg)) * 31 + (n.getArg4().accept(this, arg)) * 31 + (n.isNegated() ? 1 : 0) * 31 + (n.getOperator().accept(this, arg)) * 31 + (n.getRight().accept(this, arg)) * 31 + (n.getComment().isPresent() ? n.getComment().get().accept(this, arg) : 0);
    }

    @Override
    public Integer visit(final PointFreeExpr n, final Void arg) {
        return (n.getArg1().accept(this, arg)) * 31 + (n.getArg2().accept(this, arg)) * 31 + (n.getArg3().accept(this, arg)) * 31 + (n.getArg4().accept(this, arg)) * 31 + (n.getLeft().accept(this, arg)) * 31 + (n.isNegated() ? 1 : 0) * 31 + (n.getOperator().accept(this, arg)) * 31 + (n.getRight().accept(this, arg)) * 31 + (n.getComment().isPresent() ? n.getComment().get().accept(this, arg) : 0);
    }

    @Override
    public Integer visit(final ListCreationLiteralExpressionElement n, final Void arg) {
        return (n.getValue().accept(this, arg)) * 31 + (n.getComment().isPresent() ? n.getComment().get().accept(this, arg) : 0);
    }
    ...
    public Integer visit(final MapCreationLiteralExpressionKeyValuePair n, final Void arg) {
        return (n.getKey().accept(this, arg)) * 31 + (n.getValue().accept(this, arg)) * 31 + (n.getComment().isPresent() ? n.getComment().get().accept(this, arg) : 0);
    }
    ...
    @Override
    public Integer visit(final NullSafeFieldAccessExpr n, final Void arg) {
        return (n.getName().accept(this, arg)) * 31 + (n.getScope().accept(this, arg)) * 31 + (n.getTypeArguments().isPresent() ? n.getTypeArguments().get().accept(this, arg) : 0) * 31 + (n.getComment().isPresent() ? n.getComment().get().accept(this, arg) : 0);
    }
