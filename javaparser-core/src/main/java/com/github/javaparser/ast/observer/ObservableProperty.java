...
public enum ObservableProperty {
    ...
    ARG1(Type.SINGLE_REFERENCE),
    ARG2(Type.SINGLE_REFERENCE),
    ARG3(Type.SINGLE_REFERENCE),
    ARG4(Type.SINGLE_REFERENCE),
    ARGUMENTS(Type.MULTIPLE_REFERENCE),
    ASTERISK(Type.SINGLE_ATTRIBUTE),
    BACK_REFERENCES_COUNT(Type.SINGLE_ATTRIBUTE),
    BIND(Type.SINGLE_REFERENCE),
