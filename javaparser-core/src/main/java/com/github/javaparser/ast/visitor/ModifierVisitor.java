...
public class ModifierVisitor<A> implements GenericVisitor<Visitable, A> {
    ...
    @Override
    public Visitable visit(final BigIntegerLiteralExpr n, final A arg) {
        Comment comment = n.getComment().map(s -> (Comment) s.accept(this, arg)).orElse(null);
        n.setComment(comment);
        return n;
    }
    ...
    @Override
    public Visitable visit(final DrlNameExpr n, final A arg) {
        SimpleName name = (SimpleName) n.getName().accept(this, arg);
        Comment comment = n.getComment().map(s -> (Comment) s.accept(this, arg)).orElse(null);
        if (name == null)
            return null;
    ...
    @Override
    public Visitable visit(final HalfBinaryExpr n, final A arg) {
        Expression right = (Expression) n.getRight().accept(this, arg);
        Comment comment = n.getComment().map(s -> (Comment) s.accept(this, arg)).orElse(null);
        if (right == null)
            return null;
